...
const sendNotificationReq = require("../utils/notificationClient").default
...
exports.createTicket = async (req, res) => {
    try {
        ...
        if (ticketCreated) {
            ...
            sendNotificationReq(`Ticket created with id : ${ticketCreated._id}` , "Compaint has been booked",`${customer.email}, ${engineer.email},kankvish@gmail.com`, "CRM APP");
